...
!(function(e, t) {
  ...
  (function() {
    ...
    function e(e, n) {
      ...
      function y(e, t, r) {
        for (
          var n = r(e.toString()), o = r(t.toString()), a = 0;
          n[a] && o[a];
          a++
        )
          if (n[a] !== o[a]) {
      ...
      function N(e) {
        for (
          var t, r, n = [], o = 0, a = -1, l = 0;
          (t = (r = e.charAt(o++)).charCodeAt(0));
      ...
      function C(e, r) {
        ...
        for (0 !== p && (p = 0); 0 === n && d > p; ) {
          ...
          if (
            ...
            n = l.sortFunction(e, r)
          else if ('rand' == l.order) n = Math.random() < 0.5 ? 1 : -1
          else {
            var c = a,
              g = w(e, l),
              m = w(r, l),
      ...
      function w(e, t) {
        ...
        return (
          t.selector &&
            (t.hasFilter
              ? n.matchesSelector(t.selector) || (n = l)
              : (n = n.querySelector(t.selector))),
          t.hasAttr
            ...
            : t.useVal
              ...
              : t.hasData
                ...
                : n && (r = n.textContent),
          x(r) &&
            (t.cases || (r = r.toLowerCase()), (r = r.replace(/\s+/g, ' '))),
          null === r && (r = g),
          r
        )
      }
      ...
      x(e) && (e = c.querySelectorAll(e)),
        0 === e.length && console.warn('No elements to sort')
      var D,
        M,
        ...
        O =
          ...
          (n === o || n.useFlex !== !1) &&
          !L &&
          -1 !== getComputedStyle(z, null).display.indexOf('flex')
      return (
        s.apply(l, Array.prototype.slice.call(arguments, 1)),
        S(),
        R.sort(C),
        b(),
        R.map(function(e) {
        ...
        (function(e) {
          e.matchesSelector =
            ...
            function(e) {
              for (
                var t = this,
                  r = (t.parentNode || t.document).querySelectorAll(e),
                  n = -1;
                r[++n] && r[n] != t;
...
;(function(global, factory) {
  ...
  function initialize(options) {
    ...
    $('table.sortable').each(function() {
      ...
      $this.find('> thead [rowspan]').each(function() {
        ...
        for (var i = 1; i < rowspan; i++) {
          ...
          nextRow
            .children()
            .eq(index)
            .before('<th class="rowspan-compensate">')
        }
      })
      ...
      $this.find('th').each(function() {
        var $header = $(this)
        if (
          $header.attr('data-dateformat') !== undefined &&
          momentJsAvailable
        ) {
          ...
          $this.find('td:nth-child(' + (colNumber + 1) + ')').each(function() {
            ...
            $cell.attr(
              'data-value',
              moment($cell.text(), $header.attr('data-dateformat')).format(
                'YYYY/MM/DD/HH/mm/ss'
              )
            )
          })
          ...
          $this.find('td:nth-child(' + (colNumber + 1) + ')').each(function() {
            ...
            $cell.attr(
              'data-value',
              new RegExp($header.attr('data-valueprovider')).exec(
                $cell.text()
              )[0]
            )
          })
      ...
      $this.find('td').each(function() {
        ...
        if ($cell.attr('data-dateformat') !== undefined && momentJsAvailable) {
          $cell.attr(
            'data-value',
            moment($cell.text(), $cell.attr('data-dateformat')).format(
              'YYYY/MM/DD/HH/mm/ss'
            )
          )
          ...
          $cell.attr(
            'data-value',
            new RegExp($cell.attr('data-valueprovider')).exec($cell.text())[0]
          )
        } else {
      ...
      $this
        .find('> thead th[data-defaultsort!="disabled"]')
        .each(function(index) {
          var $header = $(this)
          ...
          bsSort[sortKey] = applyLast
            ? bsSort[sortKey]
            : $header.attr('data-defaultsort')
          if (
            bsSort[sortKey] !== undefined &&
  ...
  $document.on(
    'click',
    'table.sortable>thead th[data-defaultsort!="disabled"]',
    function(e) {
      sortByColumn(this)
    }
  )
  ...
  function doSort($this, $table) {
    ...
    if ($.browser.mozilla) {
      ...
      $this
        .children()
        .eq(0)
        .append('<span class="sign ' + localSignClass + '"></span>')
    } else {
    ...
    $table
      .find('> tbody > tr > td.sorted,> thead th.sorted')
      .removeClass('sorted')
